...
def show_about_me():
    ...
    Ищу работу в области бекенд-разработки на python, разработки DWH, тестирования, Data Engineer.  
    
    Проекты, которые я реализовал, можно посмотреть в разделе проекты или на моем [GitHub](https://github.com/kulakov544)
    """)
